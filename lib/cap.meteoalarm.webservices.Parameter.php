...
if($conf->meteoalarm == 1)
{
	...
	if($import == "") $import = true;
		...
		$authentication=array(
		    ...
		    'sourceapplication'=>'getParamInfo',
    ...
    'EMMA_ID'=>$_GET["EMMA_ID"]);
			...
			$parameters = array('authentication'=>$authentication, 'getParamInfo'=>$GenInsInput);
			
			$ParameterArray = $soapclient->call('getParamInfo',$parameters,$ns,'');
